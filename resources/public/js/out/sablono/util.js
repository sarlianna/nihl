...
var x__19011__auto__ = (((x == null))?null:x);
var m__19012__auto__ = (sablono.util.to_str[goog.typeOf(x__19011__auto__)]);
if(!((m__19012__auto__ == null))){
return m__19012__auto__.call(null,x);
} else {
var m__19012__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__19012__auto____$1 == null))){
return m__19012__auto____$1.call(null,x);
} else {
...
var x__19011__auto__ = (((x == null))?null:x);
var m__19012__auto__ = (sablono.util.to_uri[goog.typeOf(x__19011__auto__)]);
if(!((m__19012__auto__ == null))){
return m__19012__auto__.call(null,x);
} else {
var m__19012__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19012__auto____$1 == null))){
return m__19012__auto____$1.call(null,x);
} else {
...
var len__19414__auto___25625 = arguments.length;
var i__19415__auto___25626 = (0);
while(true){
if((i__19415__auto___25626 < len__19414__auto___25625)){
args__19421__auto__.push((arguments[i__19415__auto___25626]));

var G__25627 = (i__19415__auto___25626 + (1));
i__19415__auto___25626 = G__25627;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__19422__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq25624){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25624));
});
/**
...
var vec__25629 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__25629,(0),null);
var words = cljs.core.nthnext.call(null,vec__25629,(1));
...
var G__25631 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__25631,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__25631;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__18356__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1454621193476